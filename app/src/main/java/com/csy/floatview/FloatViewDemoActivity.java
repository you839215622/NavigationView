...
/**
 * Created by chensy160806 on 2016/9/23.
 */
public class FloatViewDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floatviewdemo);
        init();
    ...
    private void init() {
        ...
        floatView=new FloatView(this,0,0,R.layout.floatview_layout);
